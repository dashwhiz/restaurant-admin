...
/**
 * Type-to-filter product picker for the Кало calculator. A native <select>
 * means scrolling hundreds of options to find one; here you type a few
 * letters instead. Modeled on recipes/components/ProductPicker.tsx (same
 * problem, same list).
 */
