...
// Sections, order and labels copied from the old HTML app. The owner works from
// muscle memory built there; regrouping the menu "more logically" costs him
// every time he goes looking for a page.
//
...
export const NAV_GROUPS: NavGroup[] = [
  {
    title: 'Преглед',
    items: [{ href: '/', label: 'Контролна табла', icon: IconDashboard }],
  },
  {
    title: 'Каталог',
    items: [
